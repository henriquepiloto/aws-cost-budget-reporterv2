...
resource "aws_ecs_task_definition" "frontend" {
  ...
  container_definitions = jsonencode([
    {
      name  = "frontend"
      image = "${data.aws_caller_identity.current.account_id}.dkr.ecr.${var.aws_region}.amazonaws.com/${local.project_name}/frontend:latest"
      ...
      environment = [
        ...
        {
          name  = "API_URL"
          value = "https://costs.selectsolucoes.com"
        },
        {
          name  = "DB_HOST"
          value = "glpi-database-instance-1.cnhjpcs7r4ar.us-east-1.rds.amazonaws.com"
